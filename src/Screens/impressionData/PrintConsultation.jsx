...
export default function PrintConsultation(props) {
                ...
                <div style={{border : "1px solid #333", width : "90%", display : "flex", justifyContent : "space-between", margin : 20, padding : 10}}>
                    <table style={{height : "10px"}}>
                        ...
                        <tr>
                            ...
                            <td>{new Date(objet[1].date_consultation).toLocaleDateString()}</td>
                        </tr>
                        <tr>
                            <td>Nom et prenom : </td>
                    ...
                    <div className="flex">
                        <table style={{zIndex : 0}}>
                            <tr>
                                ...
                                <td>{objet[1].type_de_consultation}</td>
                            </tr>
                            <tr>
                                <td>Expression des resultats : </td>
                                <td>{objet[1].resultat}</td>
                            </tr>
                            <tr>
