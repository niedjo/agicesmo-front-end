...
export default function PrintAdministration(props) {
            ...
            <center>
                ...
                <div className="header">
                    ...
                    <div className="desc-center">
                        ...
                        <div className="desc desc3">{Constant.service[4]}</div>
                    </div>
                </div>
                ...
                <div style={{border : "1px solid #333", width : "90%", display : "flex", justifyContent : "space-between", margin : 20, padding : 10}}>
                    <table style={{height : "10px"}}>
                        ...
                        <tr>
                            ...
                            <td>{new Date(objet[1].date_administration).toLocaleDateString()}</td>
                        </tr>
                        <tr>
                            <td>Nom et prenom : </td>
                ...
                <div className="body">
                    <div className="flex">
                        <table style={{zIndex : 0}}>
                            <tr>
                                <td><b>Nature du document :</b> </td>
                                <td>{objet[1].nature_du_document}</td>
                            </tr>
                            <tr>
                                <td><b>Contenue du document : </b></td>
                                <td>{objet[1].contenue_du_document}</td>
                            </tr>
                            <tr>
