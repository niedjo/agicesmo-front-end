            ...
            const response = await fetch(
                `${Constant.ipUrl}setExam.php`,
                {
                    ...
                    body : JSON.stringify({
                        ...
                        Couleur_et_aspect_des_Urines : Couleur_et_aspect_des_Urines.current.value,
                        PH : PH.current.value,
        ...
        <center>
            ...
            <form className='form-group form-group1 col-md-8' style={{display : "flex", justifyContent: "space-around", alignItems : "center"}} onSubmit={handleSubmit}>
                <table>
                    ...
                    <tr>
                        <td>Couleur et aspect des Urines</td>
                        <td><input type="text" className="form-control" ref={Couleur_et_aspect_des_Urines}/></td>
                        <td>PH</td>
                    ...
                    <tr>
                        <td>Cristaux</td>
                        <td><input type="text" className="form-control" ref={Cristaux}/></td>
                    </tr>
                    <tr>
