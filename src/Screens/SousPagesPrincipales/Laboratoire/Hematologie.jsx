...
const Hematologie = (props) => {
    ...
    const Groupe_sanguin_et_rhesus = useRef(null)
    const Electrophorese_HB = useRef(null)
            ...
            const response = await fetch(
                `${Constant.ipUrl}setExam.php`,
                {
                    ...
                    body : JSON.stringify({
                        ...
                        Examen : "HEMATOLOGIE",
                        Groupe_sanguin_et_rhesus : Groupe_sanguin_et_rhesus.current.value,
                        Electrophorese_HB : Electrophorese_HB.current.value,
                        TS : TS.current.value,
                        TC : TC.current.value,
                        VS : VS.current.value,
                    })
    ...
    <div style={{background : "whitesmoke", height : "100%"}}>
        ...
        <center>
            ...
            <form className='form-group form-group1 col-md-5' onSubmit={handleSubmit}>
                <table>
                    <tr>
                        <td>Groupe sanguin et rhesus</td>
                        <td>
                            <select className="form-control" ref={Groupe_sanguin_et_rhesus}>
                    ...
                    <tr>
                        <td>Electrophorese HB</td>
                        <td><input type="number" className="form-control" ref={Electrophorese_HB}/></td>
                    </tr>
                    <tr>
                        <td>TS</td>
                        <td><input type="number" className="form-control" ref={TS}/></td>
                    </tr>
                    <tr>
                        <td>TC</td>
                        <td><input type="number" className="form-control" ref={TC}/></td>
                    </tr>
                    <tr>
                        <td>VS</td>
                        <td><input type="number" className="form-control" ref={VS}/></td>
                    </tr>
                    <tr>
